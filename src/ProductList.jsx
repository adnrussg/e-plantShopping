    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <span className="cart_quantity_count">{getTotalItemsCount()}</span></h1></a></div>
            </div>
        </div>
        {!showCart? (
                    ...
                    <div className="product-list">
                        {category.plants.map((plant, plantIndex) => (
                            <div className="product-card" key={plantIndex}>
                                ...
                                <button
                                    className={`product-button ${addedToCart[plant.name] ? 'btn-disabled product-button added-to-cart' : ''}`}
